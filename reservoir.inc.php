...
class Reservoir
{
    ...
    public function pushToZoho( $record )
    {
      ...
      $zohoRecordId = $this->zoho->insert_lead_in_crm($info_array);
      ...
      if ($recordId) {
              ...
              if ($zohoRecordId && $attachment && $attachment != '') {
                  $this->zoho->attach_resume($zohoRecordId, $attachment);
              }
              return $recordId;
            }else {
